...
public class EmployeeIntegrationTests : IntegrationTest
{
    ...
    [Fact]
    public async Task WhenAskedForAnEmployee_AndEmployeeIdIs1_ShouldReturnCorrectEmployee()
    {
    ...
    [Fact]
    public async Task WhenAskedForAnEmployee_AndEmployeeIdIs2_ShouldReturnCorrectEmployee()
    {
    ...
    [Fact]
    public async Task WhenAskedForAnEmployee_AndEmployeeIdIs3_ShouldReturnCorrectEmployee()
    {
    ...
    [Fact]
    public async Task WhenAskedForANonexistentEmployee_AndIdIsMinInt_ShouldReturn404()
    {
    ...
    [Fact]
    public async Task WhenAskedForANonexistentEmployee_AndIdIsZero_ShouldReturn404()
    {
        var response = await HttpClient.GetAsync("/api/v1/employees/0");
        await response.ShouldReturn(HttpStatusCode.NotFound);
    }
